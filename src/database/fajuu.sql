...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-08-2024 a las 22:28:16
...
(9096, 80506, 'Pollos Hermanos', 'Bogota', 'cll 54 #98', 'pollos@mail.com', 313340449, 'activo');
...
(321, 6, '{\"7\": [\"Pan\", \"1\", \"Unidad\"]}', '2024-08-23'),
(3151, 6, '{\"10\": [\"Pan\", \"12\", \"Unidad\"]}', '2024-08-23'),
(5123, 6, '{\"8\": [\"Carne\", \"4\", \"Gramo\"]}', '2024-08-23');
...
(2, 9096, '{\"10\": [\"Pan\", \"2\", \"Unidad\"], \"8\": [\"Carne\", \"1\", \"Gramo\"]}', '2024-08-23');
...
(8, 'Carne', 1, 'Gramo', 1500, 'agotado', 0),
(10, 'Pan', 3, 'Unidad', 500, 'disponible', 4);
...
(6, 42, 'Proveedor Maiz', 'maiz@mail.com', 2147483647, 'activo'),
(7, 123, 'Proveedor Carne', 'carne@gmail.com', 32133421, 'innactivo');
...
(123, 'Juan', 'Figueroa', '1$k9phlL3jK4wjcPHR$4972014ced28bbb3b8376bda50de594a01633eee2b2a8a494199b39f053dc05625d2a188c1983d8d66d', 'juan@mail.com', 3123123, 1, 'activo'),
(1013101334, 'Juan david', 'Cuvides', 'juanito', 'juadcuvides@gmail.com', 32133123, 1, 'activo');
...
--
ALTER TABLE `clientes`
  MODIFY `clien_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9102;

--
-- AUTO_INCREMENT de la tabla `facturas`
--
ALTER TABLE `facturas`
  MODIFY `fact_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
