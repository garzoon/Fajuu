...
app.register_blueprint(login_scope, url_prefix="/login")
...
app.register_blueprint(factura_proveedor_scope, url_prefix="/factura_proveedor")
app.register_blueprint(factura_cliente_scope, url_prefix="/factura_cliente")
